...
The device design is inspired from fireflies, bio-inspired design. The bioluminiscent effect overlaps with our design , where emitting light  is the medium of interaction. Factors such as how it is worn affects the form, it can be a ring, wristband, necklace, shoes sole, pin. Visibility also plays a role in form design. Also, privacy & consent of the user need to be considered, what if the user does not want the other person to know that they are a match? How will we maintain privacy? 
